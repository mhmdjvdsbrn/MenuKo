	...
	var Cropit = (function () {
	  ...
	  _createClass(Cropit, [{
	    ...
	    value: function init() {
	      ...
	      this.$preview = this.options.$preview.css('position', 'absolute');
	    ...
	    set: function (newZoom) {
	      ...
	      var num = (this.zoomSliderPos)*100;
        
          $("#zommer_range_input").css({"background":"linear-gradient(to right, #6ae3ff 0%, #6ae3ff " + num + "%, #fff " + num + "%, white 100%)"});
